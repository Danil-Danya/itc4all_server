const generateVerifyTemplate = (link) => {
    return `
        <div style="margin: 0 auto; max-width: 480px; width: 100%; padding: 0 15px;">
            <div style="margin: 30px auto; max-width: 480px; width: 100%; height: 600px; background-color: #376FFF; border-radius: 10px;">
                ...
                <a href="${link}" style="font-family: 'Montserrat', sans-serif; font-weight: 500; margin: 0 auto; text-align: center; display:block; color: #fff; text-decoration: none;">Go toverify link</a>
            </div>
        </div>
    `
}

export default generateVerifyTemplate;